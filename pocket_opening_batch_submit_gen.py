...
file_list_path = "/expanse/lustre/projects/was136/vmischley/vmischley_04_28/Exemplar_Screen_01_17/Pocket_Opening/pocket_opening_command_list_updated.txt"
...
chunks = list(chunk_list(file_paths, 2))

# Create a job file for each chunk
for i, chunk in enumerate(chunks):
    # Define job file name
    job_file_name = f"po_{i + 1}.sb"
